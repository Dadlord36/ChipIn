...
namespace HttpRequests.RequestsProcessors.GetRequests
{
    ...
    {
        public GetInterestsQuestionsAnswersGetRequestProcessor(out DisposableCancellationTokenSource cancellationTokenSource, IRequestHeaders requestHeaders,
            int interestId) : base(out cancellationTokenSource, ApiCategories.Subcategories.Interests, HttpMethod.Get, requestHeaders,
            new[] {interestId.ToString()})
        {
        }
    }
}