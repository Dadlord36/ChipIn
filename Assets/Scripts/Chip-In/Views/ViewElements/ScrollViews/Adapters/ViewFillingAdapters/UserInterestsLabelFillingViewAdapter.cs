...
namespace Views.ViewElements.ScrollViews.Adapters.ViewFillingAdapters
{
    ...
    {
        public override InterestItemViewModel.FieldFillingData Convert(DisposableCancellationTokenSource cancellationTokenSource,
            InterestBasicDataModel data, uint dataIndexInRepository)
        {
            return new InterestItemViewModel.FieldFillingData(data);
        }
    }
}