...
public class CodeReader : MonoBehaviour
{
    ...
    public Task<Result> DecodeQRAsync()
    {
        if (!isReadyForRead || previewctr.Devicecamera.Width() < 100)
        {
        ...
        return Task.Run(() => barReader.Decode(dataColor, scanWidth, scanHeight));
    }
